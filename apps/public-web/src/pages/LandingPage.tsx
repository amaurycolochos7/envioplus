...
import { FOUNDING_YEAR, FoundingBadge } from '../components/SiteFooterYear';
            ...
            < footer className="footer" id="contacto" >
                <div className="container">
                    ...
                    <div className="footer-bottom">
                        <a href="https://admin.envioplus.com.mx" style={{ color: 'inherit', textDecoration: 'none' }} title="Panel de administración">&copy; {FOUNDING_YEAR} EnvioPlus. Todos los derechos reservados.</a>
