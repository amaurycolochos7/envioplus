                            ...
                            <div className="trk-modal-overlay" onClick={() => setHelpOpen(false)}>
                                <div className="trk-modal" onClick={(e) => e.stopPropagation()}>
                                    ...
                                    <div className="trk-help-options">
                                        <a href="tel:+525565872156" className="trk-help-option">
                                            ...
                                            <div>
                                                ...
                                                <span>+52 55 6587 2156</span>
                                            </div>
                                        </a>
                                        <a href="https://wa.me/525565872156" target="_blank" rel="noopener noreferrer" className="trk-help-option">
