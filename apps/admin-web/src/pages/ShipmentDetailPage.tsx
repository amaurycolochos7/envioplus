...
export default function ShipmentDetailPage() {
    ...
    // La edición completa queda reservada a ADMIN y SUPERVISOR (igual que en la API)
    const canEdit = ['ADMIN', 'SUPERVISOR'].includes(getStoredUser()?.role);
        ...
        <>
            ...
            <div className="topbar">
                ...
                <div className="topbar-right" style={{ gap: 8 }}>
                    ...
                    {canEdit && (
                        <button className="btn btn-sm btn-primary" onClick={() => navigate(`/shipments/${id}/edit`)}>{Icons.edit} Editar guía</button>
                    )}
